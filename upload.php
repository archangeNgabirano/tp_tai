...
<body>
	...
	<div class="container mt-3">
				...
				<form action="upload.php" method="post" enctype="multipart/form-data">
					...
					<input type="submit" name="upload" value="Upload" class="btn btn-success ml-6">
				<a style="text-align: center;" href="index.php" class="btn btn-primary mt-6">Affichage</a></center>
				</form>
				</div>
	</div>
</body>
